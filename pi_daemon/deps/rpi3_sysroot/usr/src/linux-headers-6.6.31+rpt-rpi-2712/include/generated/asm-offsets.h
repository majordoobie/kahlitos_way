...
#define TSK_STACK_CANARY 1408 /* offsetof(struct task_struct, stack_canary) */

#define THREAD_CPU_CONTEXT 6704 /* offsetof(struct task_struct, thread.cpu_context) */
#define THREAD_SCTLR_USER 7792 /* offsetof(struct task_struct, thread.sctlr_user) */
#define THREAD_KEYS_USER 7688 /* offsetof(struct task_struct, thread.keys_user) */
#define THREAD_KEYS_KERNEL 7768 /* offsetof(struct task_struct, thread.keys_kernel) */
#define THREAD_MTE_CTRL 7784 /* offsetof(struct task_struct, thread.mte_ctrl) */
...
#define TRAMP_VALIAS -549791596544 /* TRAMP_VALIAS */
