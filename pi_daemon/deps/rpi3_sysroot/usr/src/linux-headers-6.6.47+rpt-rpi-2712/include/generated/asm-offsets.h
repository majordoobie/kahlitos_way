...
#define THREAD_CPU_CONTEXT 6720 /* offsetof(struct task_struct, thread.cpu_context) */
#define THREAD_SCTLR_USER 7808 /* offsetof(struct task_struct, thread.sctlr_user) */
#define THREAD_KEYS_USER 7704 /* offsetof(struct task_struct, thread.keys_user) */
#define THREAD_KEYS_KERNEL 7784 /* offsetof(struct task_struct, thread.keys_kernel) */
#define THREAD_MTE_CTRL 7800 /* offsetof(struct task_struct, thread.mte_ctrl) */
